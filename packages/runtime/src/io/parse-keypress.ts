...
// it filters these only in its detection lifecycle (ink.tsx), the layer solid-tui
...
const parseKittySpecialKey = (s: string): Keypress | null => {
...
export function parseKeypress(s: Uint8Array | string = ""): Keypress {
  let parts;
