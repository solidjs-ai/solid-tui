...
const UNATTACHED_YOGA = Symbol("solid-tui:yoga-unattached") as unknown as YogaNodeRef;
...
export function createTextLeaf(value: string): TuiTextLeaf {
  ...
  // createTextNode also routes through. Solid's runtime-core already stringifies
